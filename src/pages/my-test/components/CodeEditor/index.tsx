...
import MiniMenu from '@/pages/my-test/components/CodeEditor/components/MiniMenu';
...
import MemoPopup from '@/pages/my-test/components/CodeEditor/components/MemoPopup';
import ActiveMiniMenu from '@/pages/my-test/components/CodeEditor/components/ActiveMiniMenu';
